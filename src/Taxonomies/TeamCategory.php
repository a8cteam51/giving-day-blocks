	...
	protected function get_taxonomy_args(): array {
		return array(
			'labels'            => array(
				...
				'all_items'     => __( 'All Categories', 'giving-day-blocks' ),
				'parent_item'   => __( 'Parent Category', 'giving-day-blocks' ),
				'edit_item'     => __( 'Edit Category', 'giving-day-blocks' ),
				'add_new_item'  => __( 'Add New Category', 'giving-day-blocks' ),
				'search_items'  => __( 'Search Categories', 'giving-day-blocks' ),
				'not_found'     => __( 'No categories found.', 'giving-day-blocks' ),
			),
